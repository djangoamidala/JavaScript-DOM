...
// 3. Modifiez le style du paragraphe lorsque l'utilisateur passe la souris dessus (la couleur et le font size)
...
// 4. Ajoutez (créer) un nouvel élément HTML à la page lorsque l'utilisateur clique sur un bouton et l'ajouter en tant qu'element enfant de la liste et lui appliqué le texte : 'Nouvel élément'
